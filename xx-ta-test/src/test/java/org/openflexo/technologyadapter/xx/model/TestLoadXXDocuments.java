...
public class TestLoadXXDocuments extends AbstractXXTest {
	...
	public void testInitializeServiceManager() throws Exception {
		instanciateTestServiceManager(XXTechnologyAdapter.class);
	}

	@Test
	@TestOrder(3)
	public void testXXLoading() {
		XXTechnologyAdapter technologicalAdapter = serviceManager.getTechnologyAdapterService()
				.getTechnologyAdapter(XXTechnologyAdapter.class);
