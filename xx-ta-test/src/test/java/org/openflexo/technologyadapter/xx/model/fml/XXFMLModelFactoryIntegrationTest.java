...
public class XXFMLModelFactoryIntegrationTest extends AbstractModelFactoryIntegrationTestCase {

	private static final Logger logger = FlexoLogger.getLogger(XXFMLModelFactoryIntegrationTest.class.getPackage().getName());
	...
	public void initializeServiceManager() {
		...
		assertNotNull(taService.getTechnologyAdapter(XXTechnologyAdapter.class));
	}
	...
	public void checkXXFMLTechnologyAdapter() {
		...
		testVirtualModelModelFactoryWithTechnologyAdapter(
				serviceManager.getTechnologyAdapterService().getTechnologyAdapter(XXTechnologyAdapter.class));
	}
