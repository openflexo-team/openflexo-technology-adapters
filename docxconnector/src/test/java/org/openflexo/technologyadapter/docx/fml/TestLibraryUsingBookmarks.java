...
public class TestLibraryUsingBookmarks extends AbstractTestDocX {
	...
	private static final String VIEWPOINT_NAME = "TestLibraryUsingBookmarksVirtualModel";
	private static final String VIEWPOINT_URI = "http://openflexo.org/test/TestResourceCenter/TestLibraryUsingBookmarksVirtualModel.fml";
	...
	public void testLoadTemplate() throws FileNotFoundException, ResourceLoadingCancelledException, FlexoException {
		...
		System.out.println("template file: " + templateResource.getIODelegate().getSerializationArtefact());
	 ...
	 * 
	 * <code>
	 * VirtualModel LibraryVirtualModel uri="http://openflexo.org/test/TestLibraryVirtualModel/LibraryVirtualModel" {
	 * 
	 *   FlexoConcept Book {  
	...
	private static FlexoConcept createBookDescriptionSection() throws FragmentConsistencyException, InvalidNameException {
		...
		TextBinding<DocXDocument, DocXTechnologyAdapter> descriptionBinding = sectionRole.makeTextBinding(descriptionSelection,
				new DataBinding<>("book.description"), true);
		...
		createFragment.setLocation(new DataBinding<>("booksDescriptionSection.startElement"));
	...
	public void testModifySomeDataAndUpdateDocument() throws FragmentConsistencyException, SaveResourceException {
		...
		assertEquals(4, libraryVMI.getFlexoConceptInstances().size());
		// Unused FlexoConceptInstance book1 =
		libraryVMI.getFlexoConceptInstances().get(0);
		// Unused FlexoConceptInstance book2 =
		libraryVMI.getFlexoConceptInstances().get(1);
		// Unused FlexoConceptInstance book3 =
		libraryVMI.getFlexoConceptInstances().get(2);
	...
	public void testModifyDocumentAndReinjectData() throws FragmentConsistencyException, SaveResourceException {
		...
		DocXParagraph editionParagraph1 = (DocXParagraph) generatedDocument.getElements().get(20);
		DocXParagraph typeParagraph1 = (DocXParagraph) generatedDocument.getElements().get(21);
		// Unused DocXParagraph descriptionParagraph1 = (DocXParagraph)
		generatedDocument.getElements().get(22);
		DocXParagraph descriptionParagraph1bis = (DocXParagraph) generatedDocument.getElements().get(23);
		// Unused DocXFragment cpFragment =
		generatedDocument.getFragment(titleParagraph1, descriptionParagraph1bis);
	...
	public void testModifyDocumentAndReinjectData2() throws FragmentConsistencyException, SaveResourceException {
		...
		DocXParagraph titleParagraph1 = (DocXParagraph) generatedDocument.getElements().get(18);
		// Unused DocXParagraph authorParagraph1 = (DocXParagraph)
		generatedDocument.getElements().get(19);
		// Unused DocXParagraph editionParagraph1 = (DocXParagraph)
		generatedDocument.getElements().get(20);
		// Unused DocXParagraph typeParagraph1 = (DocXParagraph)
		generatedDocument.getElements().get(21);
		// Unused DocXParagraph descriptionParagraph1 = (DocXParagraph)
		generatedDocument.getElements().get(22);
		DocXParagraph descriptionParagraph1bis = (DocXParagraph) generatedDocument.getElements().get(23);
		// Unused DocXFragment cpFragment =
