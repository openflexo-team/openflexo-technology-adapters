...
public class DocXFMLModelFactoryIntegrationTest extends AbstractModelFactoryIntegrationTestCase {
	...
	public void initializeServiceManager() {
		...
		assertNotNull(taService.getTechnologyAdapter(DocXTechnologyAdapter.class));
	}
	...
	@Test
	@TestOrder(2)
	public void checkDocXFMLTechnologyAdapter() {
		log("checkDocXFMLTechnologyAdapter()");

		testVirtualModelModelFactoryWithTechnologyAdapter(
				serviceManager.getTechnologyAdapterService().getTechnologyAdapter(DocXTechnologyAdapter.class));
	}
