...
public class TestLibrary2 extends AbstractTestDocX {
	...
	private static final String VIEWPOINT_NAME = "TestLibraryVirtualModel2";
	private static final String VIEWPOINT_URI = "http://openflexo.org/test/TestResourceCenter/TestLibraryVirtualModel2.fml";
	...
	public void testCreateDocumentVirtualModel() throws SaveResourceException, FragmentConsistencyException, ModelDefinitionException {
		...
		titleBinding.setValue(new DataBinding<>(FlexoTableRoleImpl.ITERATOR_NAME + ".title"));
