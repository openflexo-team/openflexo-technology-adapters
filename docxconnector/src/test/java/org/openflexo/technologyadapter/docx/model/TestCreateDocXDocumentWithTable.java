...
public class TestCreateDocXDocumentWithTable extends AbstractTestDocX {
	...
	public void testAddTable() throws FileNotFoundException, ResourceLoadingCancelledException, FlexoException {
		...
		getParagraph(0, 1).addToRuns(newDocResource.getFactory().makeNewDocXRun("Column1"));
		getParagraph(0, 2).addToRuns(newDocResource.getFactory().makeNewDocXRun("Column2"));

		getParagraph(1, 0).addToRuns(newDocResource.getFactory().makeNewDocXRun("Item1"));
		getParagraph(1, 1).addToRuns(newDocResource.getFactory().makeNewDocXRun("item1-data1"));
		getParagraph(1, 2).addToRuns(newDocResource.getFactory().makeNewDocXRun("item1-data2"));

		getParagraph(2, 0).addToRuns(newDocResource.getFactory().makeNewDocXRun("Item2"));
		getParagraph(2, 1).addToRuns(newDocResource.getFactory().makeNewDocXRun("item2-data1"));
		getParagraph(2, 2).addToRuns(newDocResource.getFactory().makeNewDocXRun("item2-data2"));

		getParagraph(3, 0).addToRuns(newDocResource.getFactory().makeNewDocXRun("Item3"));
		getParagraph(3, 1).addToRuns(newDocResource.getFactory().makeNewDocXRun("item3-data1"));
		getParagraph(3, 2).addToRuns(newDocResource.getFactory().makeNewDocXRun("item3-data2"));
