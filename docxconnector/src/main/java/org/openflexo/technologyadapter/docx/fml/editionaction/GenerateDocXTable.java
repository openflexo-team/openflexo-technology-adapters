...
@ModelEntity
@ImplementationClass(GenerateDocXTable.GenerateDocXTableImpl.class)
@XMLElement
@FML("GenerateDocXTable")
public interface GenerateDocXTable extends DocXTableAction {

	public static abstract class GenerateDocXTableImpl extends DocXTableActionImpl implements GenerateDocXTable {

		@SuppressWarnings("unused")
		private static final Logger logger = Logger.getLogger(GenerateDocXTable.class.getPackage().getName());
