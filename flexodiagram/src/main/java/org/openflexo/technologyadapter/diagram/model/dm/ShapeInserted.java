 ...
 * 
 */
public class ShapeInserted<G extends GraphicalRepresentation> extends DiagramDataModification<DiagramShape> {

	private DiagramElement<G> _parent;

	public ShapeInserted(DiagramShape shape, DiagramElement<G> parent) {
		super(null, shape);
		_parent = parent;
	}
