 ...
 *
 */
public class MapShapeToIndividualStrategy extends FlexoConceptFromShapeCreationStrategy {
	...
	public MapShapeToIndividualStrategy(DeclareShapeInFlexoConcept transformationAction) {
