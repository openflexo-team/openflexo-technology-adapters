...
public class DiagramFMLModelFactoryIntegrationTest extends AbstractModelFactoryIntegrationTestCase {

	private static final Logger logger = FlexoLogger.getLogger(DiagramFMLModelFactoryIntegrationTest.class.getPackage().getName());
	...
	@Test
	@TestOrder(2)
	public void checkDiagramFMLTechnologyAdapter() {
		log("checkDiagramFMLTechnologyAdapter()");
