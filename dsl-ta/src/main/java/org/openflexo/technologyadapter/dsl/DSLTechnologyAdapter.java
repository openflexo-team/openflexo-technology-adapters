...
import org.openflexo.technologyadapter.dsl.fml.binding.DSLBindingFactory;
import org.openflexo.technologyadapter.dsl.rm.DSLResourceFactory;
...
public class DSLTechnologyAdapter extends TechnologyAdapter<DSLTechnologyAdapter> {
	...
	public DSLResourceFactory getXXResourceFactory() {
