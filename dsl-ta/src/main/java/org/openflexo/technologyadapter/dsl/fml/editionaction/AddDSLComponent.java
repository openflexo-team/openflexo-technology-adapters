...
@XMLElement
@FML("AddExcelRow")
public interface AddXXLine extends XXAction<DSLComponent> {
	...
	public static abstract class AddExcelRowImpl extends TechnologySpecificActionDefiningReceiverImpl<DSLModelSlot, DSLSystem, DSLComponent>
