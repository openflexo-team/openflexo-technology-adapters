...
@ImplementationClass(AbstractSelectExcelCell.AbstractSelectExcelCellImpl.class)
public interface AbstractSelectExcelCell<AT> extends AbstractFetchRequest<BasicExcelModelSlot, ExcelWorkbook, ExcelCell, AT> {
	...
	public static abstract class AbstractSelectExcelCellImpl<AT> extends AbstractFetchRequestImpl<BasicExcelModelSlot, ExcelWorkbook, ExcelCell, AT>
			implements AbstractSelectExcelCell<AT> {

		private static final Logger logger = Logger.getLogger(AbstractSelectExcelCell.class.getPackage().getName());

		private DataBinding<ExcelSheet> excelSheet;

		public AbstractSelectExcelCellImpl() {
			super();
		}
		...
		@Override
		public List<ExcelCell> performExecute(RunTimeEvaluationContext evaluationContext) {
