...
public class XMLFMLModelFactoryIntegrationTest extends AbstractModelFactoryIntegrationTestCase {

	private static final Logger logger = FlexoLogger.getLogger(XMLFMLModelFactoryIntegrationTest.class.getPackage().getName());
	...
	@Test
	@TestOrder(2)
	public void checkXMLFMLTechnologyAdapter() {
		log("checkXMLFMLTechnologyAdapter()");
