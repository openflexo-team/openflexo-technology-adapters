...
public class XSOntClass extends AbstractXSOntConcept implements IFlexoOntologyClass<XMLTechnologyAdapter>, XSOntologyURIDefinitions,
		IXMLType {
	...
	protected XSOntClass(XSOntology ontology, String name, String uri, XMLTechnologyAdapter adapter) {
		super(ontology, name, uri, adapter);
	}

	@Override
	public boolean isSuperClassOf(IFlexoOntologyClass<XMLTechnologyAdapter> aClass) {
	...
	@Override
	public boolean isSuperConceptOf(IFlexoOntologyConcept<XMLTechnologyAdapter> concept) {
		if (concept instanceof XSOntClass) {
			return isSuperClassOf((IFlexoOntologyClass<XMLTechnologyAdapter>) concept);
		} else
			return false;
	}

	@Override
	public boolean isSubConceptOf(IFlexoOntologyConcept<XMLTechnologyAdapter> concept) {
		if (concept instanceof XSOntClass) {
	...
	public void addToSuperClasses(IFlexoOntologyClass<XMLTechnologyAdapter> aClass) {
	...
	public void removeFromSuperClasses(IFlexoOntologyClass<XMLTechnologyAdapter> aClass) {
		superClasses.remove(aClass);
	}

	@Override
	public List<? extends IFlexoOntologyClass<XMLTechnologyAdapter>> getSubClasses(IFlexoOntology<XMLTechnologyAdapter> context) {
	...
	@Override
	public List<? extends IFlexoOntologyFeatureAssociation<XMLTechnologyAdapter>> getStructuralFeatureAssociations() {
