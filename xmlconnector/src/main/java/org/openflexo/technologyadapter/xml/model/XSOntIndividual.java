...
public class XSOntIndividual extends AbstractXSOntConcept implements IFlexoOntologyIndividual<XMLTechnologyAdapter>,
    ...
    private final List<XSOntIndividual>               children = new ArrayList<XSOntIndividual>();
    ...
    protected XSOntIndividual(XMLTechnologyAdapter adapter) {
        super(adapter);
    ...
    public void setName(String name) {
        ...
        // FIXME URI and Name are a non-sense here, as it is calculated by the
        // ModelSlot
        // This should be removed when inheritance to FlexoOntology will be
        // fixed
    }
    ...
    /**
     * Return the {@link IFlexoOntologyPropertyValue} matching supplied property
     * and defined for this individual<br>
    ...
    public String getContentDATA() {
        XSOntProperty propCDATA = ((XSOntClass) this.getType()).getPropertyByName(XMLCst.CDATA_ATTR_NAME);
        if (propCDATA != null) {
            XSPropertyValue val = this.getPropertyValue(propCDATA);
            if (val != null)
                return val.getValues().toString();
        }
        return null;
    }
    ...
    @Override
    public List<XSOntIndividual> getChildren() {
     ...
     * Return the {@link IFlexoOntologyPropertyValue} matching supplied property
     * and defined for this individual<br>
     * If the supplied valueToRemove parameter was the only value defined for
     * supplied property for this individual, return null
     * 
     * @param property
     * @param valueToRemove
     * @return
