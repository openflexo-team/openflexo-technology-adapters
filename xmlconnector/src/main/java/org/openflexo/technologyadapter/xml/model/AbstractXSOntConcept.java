...
public abstract class AbstractXSOntConcept extends AbstractXSOntObject implements IFlexoOntologyConcept<XMLTechnologyAdapter> {
	...
	protected AbstractXSOntConcept(XSOntology ontology, String name, String uri, XMLTechnologyAdapter adapter) {
	...
	protected AbstractXSOntConcept(XMLTechnologyAdapter adapter) {
	...
	@Override
	public boolean equalsToConcept(IFlexoOntologyConcept<XMLTechnologyAdapter> o) {
		// TODO Ask Sylvain
		return false;
	}
	 ...
	 */
	@Override
	public List<? extends IFlexoOntologyFeatureAssociation<XMLTechnologyAdapter>> getBehaviouralFeatureAssociations() {
		return Collections.emptyList();
	}
