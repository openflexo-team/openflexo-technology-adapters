...
/**
 * Implements {@link ActorReference} for {@link OSLCObject} as modelling elements.<br>
 * 
 * @author vincent
 * 
 * @param <T>
 ...
 */
@ModelEntity
@ImplementationClass(OSLCActorReference.OSLCActorReferenceImpl.class)
@XMLElement
@FML("OSLCActorReference")
public interface OSLCActorReference<T extends OSLCObject> extends ActorReference<T> {
	...
	public abstract static class OSLCActorReferenceImpl<T extends OSLCObject> extends ActorReferenceImpl<T> implements
			OSLCActorReference<T> {

		private static final Logger logger = FlexoLogger.getLogger(OSLCActorReference.class.getPackage().toString());
