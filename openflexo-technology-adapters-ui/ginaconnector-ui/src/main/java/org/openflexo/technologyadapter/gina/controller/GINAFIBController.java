 ...
 * @author sylvain
 */
public class GINAFIBController extends FlexoFIBController {

	protected static final Logger logger = FlexoLogger.getLogger(GINAFIBController.class.getPackage().getName());

	public GINAFIBController(FIBComponent component, GinaViewFactory<?> viewFactory) {
