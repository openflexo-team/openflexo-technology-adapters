...
public class NewFreeplaneMapInitializer
		extends ActionInitializer<NewFreeplaneMap, RepositoryFolder<IFreeplaneResource, ?>, RepositoryFolder<IFreeplaneResource, ?>> {
	...
	protected FlexoActionInitializer<NewFreeplaneMap> getDefaultInitializer() {
		return (event, action) -> instanciateAndShowDialog(action, FreeplaneFIBLibrary.NEW_MAP_DIALOG_FIB);
	}
}
