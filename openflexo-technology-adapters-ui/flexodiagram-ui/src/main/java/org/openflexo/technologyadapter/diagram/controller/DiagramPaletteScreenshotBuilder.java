...
public class DiagramPaletteScreenshotBuilder extends ScreenshotBuilder<DiagramPalette> {
	...
	@Override
	public JComponent getScreenshotComponent(DiagramPalette diagramPalette) {

		DiagramPaletteEditor editor = new DiagramPaletteEditor(diagramPalette, true);
