...
public class CreateObjectPropertyInitializer extends ActionInitializer<CreateObjectProperty, OWLObject, OWLConcept<?>> {
	...
	@Override
	protected FlexoActionRunnable<CreateObjectProperty, OWLObject, OWLConcept<?>> getDefaultInitializer() {
		return (e, action) -> instanciateAndShowDialog(action, OWLFIBLibrary.CREATE_OBJECT_PROPERTY_DIALOG_FIB);
	}

	@Override
	protected FlexoActionRunnable<CreateObjectProperty, OWLObject, OWLConcept<?>> getDefaultFinalizer() {
		return (e, action) -> {
