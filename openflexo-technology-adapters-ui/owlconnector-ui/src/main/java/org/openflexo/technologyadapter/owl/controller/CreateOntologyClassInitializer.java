...
public class CreateOntologyClassInitializer extends ActionInitializer<CreateOntologyClass, OWLObject, OWLConcept<?>> {
	...
	@Override
	protected FlexoActionRunnable<CreateOntologyClass, OWLObject, OWLConcept<?>> getDefaultInitializer() {
		return (e, action) -> instanciateAndShowDialog(action, OWLFIBLibrary.CREATE_ONTOLOGY_CLASS_DIALOG_FIB);
	}

	@Override
	protected FlexoActionRunnable<CreateOntologyClass, OWLObject, OWLConcept<?>> getDefaultFinalizer() {
		return (e, action) -> {
