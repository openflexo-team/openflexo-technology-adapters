...
/**
 * This class represent the module view for an EMF model.<br>
...
public class EMFModelView extends AbstractEMFOntologyView<EMFModel> {

	public EMFModelView(EMFModel object, FlexoController controller, FlexoPerspective perspective) {
