 ...
 * 
 * @param <T>
 *            freeplane node object type
 */

@ModelEntity(isAbstract = true)
public interface FreePlaneAction<T extends IFreeplaneNode>
		extends TechnologySpecificActionDefiningReceiver<FreeplaneModelSlot, IFreeplaneMap, T> {
