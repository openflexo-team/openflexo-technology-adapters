 ...
 * 
 */
public class FMLControlledFIBViewPointNature implements ViewPointNature {

	public static FMLControlledFIBViewPointNature INSTANCE = new FMLControlledFIBViewPointNature();

	// Prevent external instantiation
	private FMLControlledFIBViewPointNature() {
	}
	...
	public static List<VirtualModel> getFMLControlledFIBVirtualModels(ViewPoint viewPoint) {
		return INSTANCE._getFMLControlledFIBVirtualModels(viewPoint);
	}
