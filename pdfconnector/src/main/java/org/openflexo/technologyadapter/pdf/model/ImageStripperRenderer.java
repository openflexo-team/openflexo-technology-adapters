...
public class ImageStripperRenderer extends PDFRenderer {

	private COSName propertyName;

	public ImageStripperRenderer(PDDocument document, COSName propertyName) {
		super(document);
		this.propertyName = propertyName;
	}

	@Override
	protected ImageStripperDrawer createPageDrawer(PageDrawerParameters parameters) throws IOException {
		return new ImageStripperDrawer(parameters);
	}

	public class ImageStripperDrawer extends PageDrawer {

		public ImageStripperDrawer(PageDrawerParameters parameters) throws IOException {
			super(parameters);
		}
