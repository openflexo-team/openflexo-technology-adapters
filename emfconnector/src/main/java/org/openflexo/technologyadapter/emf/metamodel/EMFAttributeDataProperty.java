 ...
 * @author gbesancon
 */
public class EMFAttributeDataProperty extends AEMFMetaModelObjectImpl<EAttribute>
		implements IFlexoOntologyDataProperty<EMFTechnologyAdapter> {
	/**
	 * Constructor.
	 */
	 ...
	 */
	@Override
	public IFlexoOntologyDataType<EMFTechnologyAdapter> getRange() {
