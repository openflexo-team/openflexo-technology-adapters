 ...
 * 
 */
public abstract class CSVModelImpl implements CSVModel {

    private CSVTechnologyAdapter technologyAdapter;
    	
    public CSVModelImpl() {
    }
    
    public void setTechnologyAdapter(CSVTechnologyAdapter technologyAdapter) {
