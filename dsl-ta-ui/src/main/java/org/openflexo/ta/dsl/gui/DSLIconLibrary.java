...
public class DSLIconLibrary {
	...
	public static final ImageIconResource DSL_SYSTEM_ICON = new ImageIconResource(ResourceLocator.locateResource("Icons/DSLSystem.gif"));
	public static final ImageIconResource DSL_COMPONENT_ICON = new ImageIconResource(
			ResourceLocator.locateResource("Icons/DSLComponent.gif"));
	public static final ImageIconResource DSL_SLOT_ICON = new ImageIconResource(ResourceLocator.locateResource("Icons/DSLSlot.gif"));
	public static final ImageIconResource DSL_LINK_ICON = new ImageIconResource(ResourceLocator.locateResource("Icons/DSLLink.gif"));
